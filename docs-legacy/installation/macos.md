...
1. Download the `.dmg` from the [latest release from GitHub](https://github.com/ErsatzTV/legacy/releases).
...
2. Download the `.dmg` from the [latest release from GitHub](https://github.com/ErsatzTV/legacy/releases).
